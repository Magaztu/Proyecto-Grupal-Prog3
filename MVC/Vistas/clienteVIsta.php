<?php
    class clienteVisto{
        function htmlClientes($resultado, $completado){
              ...
              <div class="card-body">
                <form action="" method="post">
                  <div class="d-grid gap-2 d-md-flex justify-content-md-between">
                    <button class="btn btn-primary slide-btn" data-actorid=" ' . $id_cliente . ' " data-bs-toggle="modal" data-bs-target="#Actualizar" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;" type="button">Actualizar</button>
                    <input type="hidden" name="delete_id" value=" '. $id_cliente .' ">
                ...
                <button type="button" class="btn btn-success liveToastBtn">Notificar</button>
