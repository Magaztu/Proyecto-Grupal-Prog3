    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="./MVC/Pages/staff.php">Staff</a></li>
            <li><a class="dropdown-item" href="./MVC/Pages/actor.php">Actores</a></li>
          </ul>
        </li>
        <!-- <li class="nav-item">
      ...
      <?php
        ...
        if(isset($_SESSION['logged_in'])){
          echo '<a href="./MVC/Vistas/loginVista.php" class="btn btn-outline-danger">Cerrar Sesión</a>';
        }
      ?>
